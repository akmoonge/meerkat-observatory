...
def _evaluate_12box_at_offset(raw, offset):
    ...
    # 1년 전 시점의 야드커브 상태 (S2 normal-after-recovery 분기용)
    ...
    # C1: 야드커브 3M10Y [C1_AUTUMN_OPT 로 가을 분기 카테고리 선택]
    if C1_AUTUMN_OPT == 0:
    ...
    # C3: 2Y10Y 보조 야드커브 (V6.6.1 baseline = V3.15.5 원형)
    C3 = {
