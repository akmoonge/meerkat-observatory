...
meerkat_observatory.py 본체와 분리. STEP 5-1: Shiller CAPE.
...
FORWARD_PE = SD / "cache" / "forward_pe.json"  # STEP 5-8 본인 수동 갱신 + GitHub Releases 호스팅
...
# ═══ STEP 5-8 Forward PE — 수동 갱신 + GitHub Releases 호스팅 ═══
@lru_cache(maxsize=1)
def load_forward_pe_history():
    """forward_pe.json 의 fpe 시계열 (수동 갱신 entries).
